...
import com.xlccc.ssm.pojo.LogoPic;
...
@Controller
public class AndroidPicController {
    @Autowired
...
//
//    }
    @RequestMapping("admin_androidPic_add")
    public String add(AndroidPic androidPic, HttpSession session, UploadedImageFile uploadedImageFile) {
        androidPicService.add(androidPic);
        String name = uploadedImageFile.getImage().getOriginalFilename();
...
//            imageFolder_git = session.getServletContext().getRealPath("img/magspace_gif");
        ...
        return "redirect:admin_androidPic_list?androidId=" + androidPic.getAndroid_id();
    }

    @RequestMapping("admin_androidPic_delete")
    public String delete(int id, HttpSession session) {
        ...
        return "redirect:admin_androidPic_list?androidId=" + ap.getAndroid_id();
     ...
     * @return
     */
    @RequestMapping("admin_androidPic_list")
