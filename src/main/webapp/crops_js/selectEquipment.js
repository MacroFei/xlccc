...
function selectSSQN(){
	...
	//alert(values+"hello");
	if(values == '') return ;
    location.href = 'equipment_selectSSQN?values=' + values;
    ...
    // var data = {
	 ...
	 //        "city" : value_2,
	 //        "district" : value_3,
	 //        "serial_number" : value_4
	 //   }
    //
    // $.ajax({
    //     type: "POST",
    //     dataType: "json",
    //     url: "equipment_selectSSQN",
    //     data: data,
    //     success: function (result) {
    //     	console.log(result)
    //     },
