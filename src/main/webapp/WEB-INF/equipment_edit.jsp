...
<section>
    <div class="mainwrapper">
        ...
        <div class="wrapper" style="min-height: 582px;">
            ...
            <div class="task">
                <p style="font-size: 22px;float: left;margin-left: 6%;position: absolute;margin-top: -1em;">设备信息编辑：</p>
            </div>

            <br>

            <div class="modal-body" style="margin-bottom: 1em;">
                <form class="form-horizontal" role="form" method="post" action="equipment_update">
                    <div class="form-group" style="margin-top: -6.5em;margin-bottom: 0.5em;">
                        <label class="col-sm-3 control-label"
                               style="line-height: 1em;margin-left: -6em;margin-top: 2em;">设备编号：</label>
                        <div class="col-sm-9" style="margin-top: 1.5em;">
                            <input type="text" class="form-control" name="serial_number" value="${e.serial_number}">
                        </div>
                    </div>

                    <div class="form-group" style="margin-top: 0em;margin-bottom: 0.5em;">
                        <label class="col-sm-3 control-label"
                               style="line-height: 1em;margin-left: -6em;margin-top: 1em;">设备类别：</label>
                        <div class="col-sm-9" style="margin-top: 1.5em;">
                            <input type="text" class="form-control" name="unit_type" value="${e.unit_type}">
                        </div>
                    </div>

                    <div class="form-group" style="margin-top: 0em;margin-bottom: 0.5em;">
                        <label class="col-sm-3 control-label"
                               style="line-height: 1em;margin-left: -6em;margin-top: 1em;">所属区域：</label>
                        <div class="col-sm-9" style="margin-top: 1em;">
                            <input type="text" class="form-control" name="province" style=" width: 130px;"
                                   value="${e.province}">
                            <p style="line-height: 2.5em;margin-top: -2.5em;margin-left: 8.1em;position: absolute;">
                                省</p>
                            <input type="text" class="form-control" name="city"
                                   style=" width: 130px;margin-top: -3.1em;margin-left: 14em;" value="${e.city}">
                            <p style="line-height: 2.5em;margin-top: -2.5em;margin-left: 18.1em;position: absolute;">
                                市</p>
                            <input type="text" class="form-control" name="district"
                                   style=" width: 130px;margin-top: -3.1em;margin-left: 27.5em;" value="${e.district}">
                            <p style="line-height: 2.5em;margin-top: -2.5em;margin-left: 28em;position: absolute;">区</p>
                        </div>
                    </div>
                    <div class="form-group" style="margin-top: 0em;margin-bottom: 0em;">
                        <label class="col-sm-3 control-label"
                               style="line-height: 1em;margin-left: -6em;margin-top: 1em;">所属公司：</label>
                        <div class="col-sm-9" style="margin-top: 1em;">
                    ...
                    <div class="modal-footer" style="height: 6em;text-align: center;border-top: 0px;">
                        <button type="button" class="btn btn-default" data-dismiss="modal"
                                style="margin-top: -10em;width: 6em;height: 3em;"><a href="equipment-management.html"
                                                                                     style="color: #fff;">返回</a>
                        </button>
                        <input type="hidden" name="id" value="${e.id}">
                        <button type="submit" class="btn btn-success" style="margin-top: -10em;width: 6em;height: 3em;">
                            提交
                        </button>
                    </div>
