        ...
        <div class="wrapper" style="min-height: 582px;">
            ...
            <div class="task">
                <p style="font-size: 18px;float: left;margin-left: 32%;">
                    <input type="text" class="form-control" id="user_id" name="user_id" placeholder="输入用户名称、手机号" style=" margin-top: 6.5em;position: absolute;width: 18em;margin-left: 5em;">
            ...
            <div style="height: 3em;width: 95%;margin-top: -4em;margin-bottom: 2em;margin-left: 2.5%;line-height: 3em;background-color: #f5fafe;">
                ...
                <button class="btn btn-primary" style="margin-left: 2em;">添加用户</button>
            </div>
            ...
            <table id="tb"  class="table table-bordered table-striped" style="width: 90%;margin-left: 5%;">
                ...
                <tr>
                    <td>
                        <input type="checkbox" id="checkbox" name="checkbox" value="${u.id}" class="inp" />
                    </td>
                    <td>${u.id}</td>
                    <td>${u.name}</td>
                    <td>${u.sex}</td>
                    ...
                    <td>${u.area}</td>
                    <td>
                        <a href="#" class="big-link" data-reveal-id="${u.id}" data-animation="fade"><button class="btn btn-success" onclick="location.href='#'">查看</button></a>
                    ...
                    <td>
                        <a href="user_edit?id=${u.id}" class="big-link" ><img src="images/editor.png" alt="编辑信息" style="margin-right:8px;"></a>

                        <a href="#" class="big-link" data-reveal-id="Modal" data-animation="none"><img src="images/password.png" alt="修改密码" style="margin-left:8px;"></a>

                        <a href="user_delete?id=${u.id}" onclick="return confirm('请确认删除');"><img src="images/delete.png" alt="删除" style="margin-left:8px;"></a>
                    </td>
                </tr>
                </c:forEach>
            ...
            <div id="Modal" class="reveal-modal-1">
                ...
                <form action="user_update" method="post">
                    <p style="line-height: 3em;margin-right: 15em;">原密码：
                        <input type="text" class="form-control" id="user_id" name="user_id" style="width: 17em;height: 2.7em;margin-left: 11em;margin-top: -3.5em;">
                    </p>
                    <p style="margin-left: -15em;line-height: 3.5em;">新密码：
                        <input type="text" class="form-control" id="user_id" name="user_id" style="width: 17em;height: 2.7em;margin-left: 31.8em;margin-top: -4em;">
                    </p>
                    <input type="hidden" id="id" name="id" value="">
                    <button type="reset" class="btn btn-default" data-dismiss="modal" style="margin-top: 3em;">重置</button>
