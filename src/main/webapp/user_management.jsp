...
<head>
    ...
    <script src="user_js/register.js"></script>
    <script src="user_js/selectName.js"></script>
    <script src="user_js/cookie.js"></script>
    <script src="user_js/updatePassword.js"></script>
    <script type="text/javascript">
        $().ready(function(){
            checkLogin();
            getValue();
        ...
        <div class="wrapper" style="min-height: 582px;">
            ...
            <div class="task">
                <p style="font-size: 18px;float: left;margin-left: 32%;">
                    <input type="text" class="form-control" id="user_id" name="user_id" placeholder="输入用户名称"
                           style=" margin-top: 6.5em;position: absolute;width: 18em;margin-left: 5em;" id>

                    <span class="search-btn" style="margin-left: 24em;margin-top: 6.5em;position: absolute;" onclick="javascript:selectUserName();">搜用户</span>
                </p>
            </div>
            ...
            <div style="height: 3em;width: 95%;margin-top: -4em;margin-bottom: 2em;margin-left: 2.5%;line-height: 3em;background-color: #f5fafe;">
                ...
                <button class="btn btn-danger" style="margin-left: 51em;" onclick="deleteAllData()">批量删除</button>
                ...
                <div id="Modal-1" class="reveal-modal-2">
                    ...
                    <form class="form-horizontal" role="form" style="margin-top: -3em;">
                        ...
                        <div class="form-group" style="margin-top: 0em;margin-bottom: 0em;">
                            ...
                            <div class="col-sm-9" style="margin-top: 1.5em;">
                                <input type="text" class="form-control" id="user_category" name="user_category">
                            </div>
                        </div>
                        <div class="form-group" style="margin-top: 0em;margin-bottom: 0em;">
                            <label class="col-sm-3 control-label"
                        ...
                        <div class="form-group" style="margin-top: 0em;margin-bottom: 0em;">
                            ...
                            <div class="col-sm-9" style="margin-top: 1.5em;">
                                <input type="text" class="form-control" id="user_region" name="user_region">
                            </div>
                        </div>

                        <button type="reset" class="btn btn-default" data-dismiss="modal" style="margin-top: 3em;">重置
                        </button>
                        <button type="button" class="btn btn-success" style="margin-top: 3em;" onclick="javascript:register();">提交</button>
                    </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="big-link" data-reveal-id="Modal" data-animation="none"><img
                                        src="images/password.png" alt="修改密码" style="margin-left:8px;" onclick="updatePassword(${u.id});" ></a>
            ...
            <form class="form-horizontal" role="form" style="margin-top: -3em;">  <!--需要用js获取id -->
                <div id="Modal" class="reveal-modal-1">
                    <h4 style="float: left;">修改密码</h4>
                    <p style="line-height: 7.5em;margin-right: 18em;">新密码：
                        <input type="text" class="form-control"  id="password" name="password"
                               style="width: 17em;height: 2.7em;margin-left: 11em;margin-top: -6.5em;">
                    </p>
                    <p style="margin-left: -15em;line-height: 3.5em;">确认密码：
                    ...
                    <button type="submit" class="btn btn-success" style="margin-top: 3em;" onclick="javascript:getPassword();">提交
                    </button>
                </div>
            </form>
            <script>
